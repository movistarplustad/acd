...
<input type="datetime" name="field[<?=$id?>][value][start]" value="<?=htmlspecialchars($fieldValue)?>" id="field_<?=$id?>"/>
-
<input type="datetime" name="field[<?=$id?>][value][end]" value="<?=htmlspecialchars($fieldValue)?>" id="field_<?=$id?>_end"/>