	...
	switch ($action) {
		...
		case 'save':
			...
			foreach ($fields as $key => $data) {
				...
				@$fields[$key]['value'] = isset($fields[$key]['value']) ? $fields[$key]['value'] : '';
				...
				if ($fieldType === 'collection' && is_array($fields[$key]['value']) && is_array($fields[$key]['type'])) {
					...
					// Optional info
					@$normalizedvalue['original_name'] = isset($fields[$key]['original_name']) ? $fields[$key]['original_name'] : '';
					@$normalizedvalue['type'] = isset($fields[$key]['type']) ? $fields[$key]['type'] : '';
					@$normalizedvalue['size'] = isset($fields[$key]['size']) ? $fields[$key]['size'] : '';
					@$normalizedvalue['width'] = isset($fields[$key]['width']) ? $fields[$key]['width'] : '';
					@$normalizedvalue['height'] = isset($fields[$key]['height']) ? $fields[$key]['height'] : '';
